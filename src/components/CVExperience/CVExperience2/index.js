...
export default function CVExperience2() {
  return (
    <>
      <div className="CVExperience2-left">
        <div className="CVExperience2-role">Team Leader</div>
        <div className="CVExperience2-role-length">Oct 2018 - Present</div>
      </div>
      <div className="CVExperience2-right">
        <h2 className="CVExperience2-header">Co-Op</h2>
        <p className="CVExperience2-body">
